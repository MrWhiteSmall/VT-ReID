...
class CPDatasetTest(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        save_parse_agnostic(new_parse_agnostic_map)
        ...
        densepose_map.save('save_densepose.jpg')
        ...
        # 保存一下
        save_agnostic = agnostic
        save_agnostic.save('save_agnostic.jpg')
